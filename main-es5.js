(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        _createClass(NewsService, [{
          ...
          value: function getNews() {
            ...
            return new Promise(function (resolve, reject) {
              _this3.httpClient.get(_this3.url + '/news').toPromise().then(function (res) {
                resolve(res);
              }, function (msg) {
                reject(msg);
              });
        ...
        _createClass(WeatherForecastComponent, [{
          ...
          value: function init() {
            ...
            this.weatherService.getWeatherForecast().then(function (weatherForecast) {
              ...
              _this5.filteredHourly.push(new src_app_models_hourly__WEBPACK_IMPORTED_MODULE_1__["Hourly"](Date.now(), weatherForecast.current.temp, weatherForecast.current.description, weatherForecast.current.iconurl));
              ...
              weatherForecast.hourly.forEach(function (hourly, index) {
                if (index % 3 === 0 && index !== 0 && index < 15) {
                  ...
                  _this5.filteredHourly.push(hourly);
                }
              });
            }).then(function () {
            ...
            this.weatherService.getWeatherForecast().then(function (weatherForecast) {
              ...
              weatherForecast.daily.forEach(function (daily) {
                ...
                if ((dateTmp === 0 || dateTmp === 6) && dayTmp !== actualDay) {
                  ...
                  _this7.filteredDaily.push(daily);
                }
              });
            }).then(function () {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _enums_widget_name__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./enums/widget-name */
      "VJva");
      /* harmony import */
      ...
      var _widgets_weather_current_weather_current_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./widgets/weather-current/weather-current.component */
      "ImvS");
      /* harmony import */


      var _widgets_digital_clock_digital_clock_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./widgets/digital-clock/digital-clock.component */
      "wMQT");
      /* harmony import */


      var _widgets_analog_clock_analog_clock_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./widgets/analog-clock/analog-clock.component */
      "r+H+");
      /* harmony import */


      var _widgets_news_news_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./widgets/news/news.component */
      "6/uA");
      /* harmony import */


      var _widgets_weather_forecast_weather_forecast_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./widgets/weather-forecast/weather-forecast.component */
      "FH2a");
      /* harmony import */


      var _widgets_weather_weekend_weather_weekend_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      function AppComponent_app_date_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_weather_current_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_digital_clock_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_analog_clock_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_news_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_weather_forecast_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_app_weather_weekend_11_Template(rf, ctx) {
        if (rf & 1) {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _widgets_weather_weekend_weather_weekend_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./widgets/weather-weekend/weather-weekend.component */
      "GpSe");
      ...
      var AnalogClockComponent = /*#__PURE__*/function () {
        ...
        _createClass(AnalogClockComponent, [{
          ...
          value: function drawClock() {
            ...
            setInterval(function () {
              return _this10.drawAnalogClock(ctx, radius);
            }, 1000);
          }
        }, {
          key: "drawAnalogClock",
      ...
      var WeatherService = /*#__PURE__*/function () {
        ...
        _createClass(WeatherService, [{
          ...
          value: function getWeather() {
            ...
            return new Promise(function (resolve, reject) {
              _this11.httpClient.get(_this11.url + '/weather').toPromise().then(function (res) {
                resolve(res);
              }, function (msg) {
                reject(msg);
              });
          ...
          value: function getWeatherForecast() {
            ...
            return new Promise(function (resolve, reject) {
              _this12.httpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].server_base_url + '/weather_forecast').toPromise().then(function (res) {
                resolve(res);
              }, function (msg) {
                reject(msg);
              });
